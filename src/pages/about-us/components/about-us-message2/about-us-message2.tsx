...
export const AboutUsMessage2 = ({ className, ...props }: AboutUsMessage2Props) => {
    return (
        ...
        >
            ...
            <Box position="relative" flexGrow="1" className={styles["content-area"]}>
                <Flex direction="column" gap="3" p="6" style={{ backgroundColor: "white" }}>
                    ...
                    <Text>
                        Restructuring crops in the direction of <strong>improving quality and efficiency</strong> is affirming the practicality and correctness in order to
                        effectively <strong>exploit potentials and advantages, responded to climate change</strong>.
                    </Text>
                    <Text>
